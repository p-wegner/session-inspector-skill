...
```powershell
& "C:\projects\org\session-inspector-skill\spawn-session\spawn.cmd" [target] [flags]
```
...
| `spawn C:\projects\some-client\product-b2` | any path |
| `-b` | bare — no seed prompt, just an empty session in that repo |
| `-W` | a new **window** instead of a tab |
| `-p 5x_4` | a specific Claude profile. Short names work: `5x_4`, `team5x_4`, `team_5x_4` all find `.claude-org_team_5x_4` |
...
[spawn] HANDOFF RECEIPT
  continued by : C--projects-org-code-metrics-skill--20189b4c
...
`org_team_5x_4`, `.claude-org_team_5x_4`, or a full path. An exact normalised
