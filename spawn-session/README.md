...
```powershell
$target = "C:\projects\org\session-inspector-skill\spawn-session"
...
normalised name — `5x_4`, `team5x_4`, `team_5x_4` and `org_team_5x_4` all find
`.claude-org_team_5x_4`. An ambiguous prefix like `5x` is refused with the
