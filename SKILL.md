...
& "C:\projects\org\spawn-session\spawn.cmd" -batch plan.json
```
...
```powershell
& "C:\projects\org\spawn-session\spawn.cmd" "<cwd>" -p auto -handoff -from <session-id> -m "why you are stopping"
```
